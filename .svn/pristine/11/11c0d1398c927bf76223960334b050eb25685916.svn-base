    ...
    OnItemClickListener, OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ImageLoaderConfiguration config =
            new ImageLoaderConfiguration.Builder(getApplicationContext()).defaultDisplayImageOptions(defaultDisplayImageOptions)
        ...
        photoAdapter =
            new PhotoSelectorAdapter(getApplicationContext(), new ArrayList<PhotoModel>(),
    ...
    public interface CancelChecked
    {
