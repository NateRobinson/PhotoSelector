...
import com.photoselector.ui.PhotoSelectorActivity.CancelChecked;

public class PhotoItem extends LinearLayout implements OnCheckedChangeListener, OnClickListener, CancelChecked
{
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
    {
        if (!isCheckAll)
        {
            listener.onCheckedChanged(PhotoItem.this, photo, buttonView, isChecked); // 调用主界面回调函数
        }
    ...
    {
        public void onCheckedChanged(PhotoItem photoItem, PhotoModel photoModel, CompoundButton buttonView,
            boolean isChecked);
    }
