...
public class BasePhotoPreviewActivity extends Activity implements OnPageChangeListener, OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btnBack = (LinearLayout)findViewById(R.id.btn_back_app);
    ...
    private OnClickListener photoItemClickListener = new OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            if (!isUp)
            {
                new AnimationUtil(getApplicationContext(), R.anim.translate_up).setInterpolator(new LinearInterpolator())
                    .setFillAfter(true)
            ...
            {
                new AnimationUtil(getApplicationContext(), R.anim.translate_down_current).setInterpolator(new LinearInterpolator())
                    .setFillAfter(true)
                    .startAnimation(layoutTop);
                isUp = false;
            }
